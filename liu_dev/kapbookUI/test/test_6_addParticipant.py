        ...
        for case_data in case_list:  #读取数据
            ...
            if authority_type == "Natural_per":
                ...
                if ver_point == 'username':
                    actual_result = self.par.show_alert('姓名提示')
                elif ver_point == 'email':
                    actual_result = self.par.show_alert('邮箱提示')
                elif ver_point == 'certificate':
                    actual_result = self.par.show_alert('证件提示')
                elif ver_point == 'title_tips':
                    actual_result = self.par.show_alert('title栏提示')
                ...
                time.sleep(2)
                if ver_point == 'title_tips':
                    actual_result = self.par.show_alert('title栏提示')
                elif ver_point == 'company_name':
                    actual_result= self.par.show_alert('企业名称提示')
                elif ver_point == 'legalPeople':
                    actual_result= self.par.show_alert('负责人提示')
                elif ver_point == 'credit_code':
                    actual_result= self.par.show_alert('社会代码提示')
